...
<body style="background: linear-gradient(135deg, #71b7e6, #9b59b6)">
	...
	<div class="title">Generate Reports</div>
	     <form action="generateReport.php" method="POST">
			...
			<br>
			<div class="btnBx">
				<input type="submit" value="Generate The Report" name="btnSearchReport" >
			</div>
		</form>	
	</div>
<br />
		...
		<br />
	<div class="container">
<h2 style="color: #060D9F; font-weight: 600; font-size: 1.8em; text-transform: uppercase; margin-bottom:20px; border-bottom: 4px solid #060D9F; display: inline-block; letter-spacing: 1px; width: 100%;">Generate Report by Location</h2><br /><br /><br />
<div class="form-group">
<div class="input-group" style="margin-left: -30px; width: 697px;">
...
<input type="text" style="border-radius: 30px;" name="search_text" id="search_text" placeholder="Search by Location" class="form-control" />
</div>
...
<div class="container">
<h2 style="color: #060D9F; font-weight: 600; font-size: 1.8em; text-transform: uppercase; margin-bottom:20px; border-bottom: 4px solid #060D9F; display: inline-block; letter-spacing: 1px; width: 100%;">Generate Report by Offence</h2><br /><br /><br />
<div class="form-group">
<div class="input-group" style="margin-left: -30px; width: 697px;">
<span class="input-group-addon" style="width: 5%; outline: none; font-weight: 400; border: 1px solid #607d8b; font-size: 16px; letter-spacing: 1px; color: white; background: #060D9F; border-radius: 30px; border-bottom-width: 2px; ">Search</span>
<input type="text" style="border-radius: 30px;" name="search_text" id="search_text_fine" placeholder="Search by Offence" class="form-control" />
</div>
...
<!-- SCRIPT for search by location  search_text_fine -->
			<script>
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"searchLocationForReport.php",
			method:"post",
			data:{query:query},
...
//<!-- SCRIPT for search by Offence   -->
$(document).ready(function(){
	load_data();
	function load_data(query1)
	{
		$.ajax({
			url:"searchFineForReport.php",
			method:"post",
			data:{query1:query1},
			success:function(data)
			{
	...
	$('#search_text_fine').keyup(function(){
		var search = $("#search_text_fine").val();
		if(search != '')
		{
			load_data(search);
		}
