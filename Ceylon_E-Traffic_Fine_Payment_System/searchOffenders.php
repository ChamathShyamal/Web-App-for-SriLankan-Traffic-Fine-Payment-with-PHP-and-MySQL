...
<link href="http://fonts.googleapis.com/css?family=Cookie" rel="stylesheet" type="text/css">
	...
	<body style="background: linear-gradient(135deg, #71b7e6, #9b59b6)">
		...
		<div style="color: #DED3D3; font-family: 'Poppins',sans-serif; text-transform: uppercase; letter-spacing: 5px; font-size: 30px; text-align: left; ">
	...
	<div style="display: flex; height: 100vh; ">
		<div class="container">
			...
			<br />
			<br />
			<h2 align="center" style="color: #060D9F; font-weight: 600; font-size: 1.8em; text-transform: uppercase; margin-bottom:20px; border-bottom: 4px solid #060D9F; display: inline-block; letter-spacing: 1px; width: 100%;">Search Offenders Details</h2><br /><br /><br />
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon" style="width: 5%; outline: none; font-weight: 400; border: 1px solid #607d8b; font-size: 16px; letter-spacing: 1px; color: white; background: #060D9F; border-radius: 30px; border-bottom-width: 2px; "><button id="offenderSearch" style="background: transparent; border: none;">Search</button></span>
					<input type="text" name="search_text" id="search_text" placeholder="Search by Offender Details" class="form-control" />
				</div>
...
$(document).ready(function(){
	$('#offenderSearch').click(function(){
		var search = $("#search_text").val();
					$.ajax({
			url:"offenderSearchFine.php",
			method:"post",
			data:{
				"btnsearch": 1,
				"search":search,
