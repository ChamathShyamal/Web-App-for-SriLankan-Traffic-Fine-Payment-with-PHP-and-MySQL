...
<div class="container">
<div class="title">Add New Fines</div>
<form action="addFine.php" method="POST">
<div class="user-details">
<div class="inputBx">
<span>Fine Name</span>
<input type="text" name="fineName" required>
</div>
<div class="inputBx">
<span>Fine Amount</span>
<input type="text" name="fineAmount" required>
</div>
</div>
<br>
<br>
<div class="btnBx">
<input type="submit" value="Add" name="addfine" >
</div>
</form>
</div>
</div>
...
if (isset($_POST['addfine'])) {
	...
	$query = "INSERT into fine (Fine_Name, Fine_Amount) VALUES('$fineName', '$fineAmount')";
	$result = mysqli_query($connection, $query);
	if ($result) {
		echo '<script>alert("Fine Added Successfully")</script>';
	}
	else{
		echo '<script>alert("Failed to add fine")</script>';
	}
}
