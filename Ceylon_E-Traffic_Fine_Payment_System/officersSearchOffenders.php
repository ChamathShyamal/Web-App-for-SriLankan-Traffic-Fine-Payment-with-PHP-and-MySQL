...
/*Ending of the footer*/
	...
	<body style="background: linear-gradient(135deg, #71b7e6, #9b59b6)">
		...
		<div class="container">
			...
			<br />
			<br />
			<h2 align="center" style="color: #060D9F; font-weight: 600; font-size: 1.8em; text-transform: uppercase; margin-bottom:20px; border-bottom: 4px solid #060D9F; display: inline-block; letter-spacing: 1px; width: 100%;">Search Offenders Details</h2><br />
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"officerSearchOffenders.php",
			method:"post",
			data:{query:query},
